...
public class EjecutarIPtable {
    ...
    public static final String[] natIPtables = {"sysctl -w net.ipv4.ip_forward=1", "iptables -t nat -A POSTROUTING -s 0.0.0.0/0 -o wlan0 -j MASQUERADE", "iptables -t nat -A PREROUTING -p tcp --dport 80 -j REDIRECT --to-port 3128","iptables -t nat -A PREROUTING -p tcp --dport 8080 -j REDIRECT --to-port 3128", "iptables -t nat -A PREROUTING -p tcp --dport 443 -j REDIRECT --to-port 3129","iptables -A FORWARD -i wlan0 -o eth0 -j ACCEPT", "iptables -A FORWARD -i eth0 -o wlan0 -j ACCEPT"};
